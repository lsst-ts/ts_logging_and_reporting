...
def get_jira_tickets(dayobs_start: datetime.date, dayobs_end: datetime.date, telescope: str) -> list[JiraTicket]:
    print(f"Getting Jira tickets for start: {dayobs_start}, end: {dayobs_end} and telescope: {telescope}")
    # TODO: replace with code to retrieve ticket information using data adaptors
