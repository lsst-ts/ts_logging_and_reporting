...
def plot_visit_skymaps(
    ...
    # Night slider
    slider = bokeh.models.Slider(start=0, end=len(unique_nights)-1, value=0, step=1, title="Night")
    ...
    # bokeh.models.CustomJS(args=dict(sources=night_renderers, slider=slider),
    # code=callback_code))
